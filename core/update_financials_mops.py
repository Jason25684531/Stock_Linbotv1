...
使用方式：python core/update_financials_mops.py --year 112 --quarter 3
"""
import sys
import os
import argparse
...
# 將專案根目錄加入 Python 路徑，確保能 import core 模組
...
範例:
  # 更新 112 年 Q3
  python core/update_financials_mops.py --year 112 --quarter 3
  
  # 測試模式（不寫入資料庫）
  python core/update_financials_mops.py --year 112 --quarter 3 --dry-run
  
  # 使用預設值（年份和季度）
  python core/update_financials_mops.py
        """
    )
