# 這段程式來自 GitHub 上的 popbo/alphas 專案
# 專案網址: https://github.com/popbo/alphas
import os
import sys
...
class Alphas191(Alphas):
    ...
    def alpha022(self):  # 1736
        ...
        return Sma(
            (
                (self.close - Mean(self.close, 6)) / Mean(self.close, 6)
                - Delay((self.close - Mean(self.close, 6)) / Mean(self.close, 6), 3)
            ),
            12,
            1,
        )
    ...
    def alpha027(self):
        ...
        A = (self.close - Delay(self.close, 3)) / Delay(self.close, 3) * 100 + (
            self.close - Delay(self.close, 6)
        ) / Delay(self.close, 6) * 100
        return Wma(A, 12)
    ...
    def alpha028(self):  # 1728
        ...
        return 3 * Sma(
            ...
            / (Tsmax(self.high, 9) - Tsmin(self.low, 9))
            * 100,
            3,
            1,
        ) - 2 * Sma(
            Sma(
                (self.close - Tsmin(self.low, 9))
                / (Tsmax(self.high, 9) - Tsmax(self.low, 9))
                * 100,
                3,
                1,
            ),
        ...
        return (
            Min(
                ...
                Rank(
                    Decaylinear(
                        Corr(
                            (self.volume), ((self.open * 0.65) + (self.open * 0.35)), 17
                        ),
                        7,
                    )
                ),
    ...
    def alpha037(self):  # 1713
        ...
        return -1 * Rank(
            (
                (Sum(self.open, 5) * Sum(self.returns, 5))
                - Delay((Sum(self.open, 5) * Sum(self.returns, 5)), 10)
            )
        )
    ...
    def alpha044(self):  # 1748
        ...
        return Tsrank(
            Decaylinear(Corr((self.low), Mean(self.volume, 10), 7), 6), 4
    ...
    def alpha047(self):  # 1759
        ...
        return Sma(
            ...
            / (Tsmax(self.high, 6) - Tsmin(self.low, 6))
            * 100,
            9,
            1,
        )
    ...
    def alpha049(self):
        ...
        part1[cond] = 0
        part1[~cond] = Max(
            Abs(self.high - Delay(self.high, 1)), Abs(self.low - Delay(self.low, 1))
        )
        part2 = self.close.copy(deep=True)
        # part2.loc[:, :] = None
        part2.loc[:, :] = np.nan
    ...
    def alpha052(self):  # 1611
        ...
        return (
            Sum(
                Max(self.high - Delay((self.high + self.low + self.close) / 3, 1), 0),
                26,
            )
            / Sum(
                Max(Delay((self.high + self.low + self.close) / 3, 1) - self.low, 0), 26
            )
            * 100
        )
    ...
    def alpha054(self):  # 1729
        ...
        return -1 * Rank(
            ((Abs(self.close - self.open)).std() + (self.close - self.open))
    ...
    def alpha061(self):  # 1790
        ...
        return (
            Max(
                Rank(Decaylinear(Delta(self.vwap, 1), 12)),
                Rank(Decaylinear(Rank(Corr((self.low), Mean(self.volume, 80), 8)), 17)),
            )
            * -1
        )
    ...
    def alpha063(self):  # 1789
        ...
        return (
            Sma(Max(self.close - Delay(self.close, 1), 0), 6, 1)
            / Sma(Abs(self.close - Delay(self.close, 1)), 6, 1)
            * 100
        )
    ...
    def alpha064(self):  # 1774
        ...
        return (
            Max(
                Rank(Decaylinear(Corr(Rank(self.vwap), Rank(self.volume), 4), 4)),
                Rank(
                    Decaylinear(
                        Tsmax(
                            Corr(Rank(self.close), Rank(Mean(self.volume, 60)), 4), 13
                        ),
                        14,
                    )
                ),
    ...
    def alpha073(self):  # 1729
        ...
        return (
            Tsrank(
                Decaylinear(Decaylinear(Corr((self.close), self.volume, 10), 16), 4), 5
            )
    ...
    def alpha074(self):  # 1402
        ...
        return Rank(
            Corr(
                Sum(((self.low * 0.35) + (self.vwap * 0.65)), 20),
                Sum(Mean(self.volume, 40), 20),
                7,
            )
    ...
    def alpha077(self):  # 1797
        ...
        return Min(
            ...
            Rank(
                Decaylinear(
                    Corr(((self.high + self.low) / 2), Mean(self.volume, 40), 3), 6
                )
            ),
        )
    ...
    def alpha078(self):  # 1637
        ...
        return (
            ...
            - Mean((self.high + self.low + self.close) / 3, 12)
        ) / (
            0.015
            * Mean(
                Abs(self.close - Mean((self.high + self.low + self.close) / 3, 12)), 12
            )
        )
    ...
    def alpha079(self):  # 1789
        ...
        return (
            ...
            / Sma(Abs(self.close - Delay(self.close, 1)), 12, 1)
            * 100
        )
    ...
    def alpha085(self):  # 1657
        ...
        return Tsrank((self.volume / Mean(self.volume, 20)), 20) * Tsrank(
            (-1 * Delta(self.close, 7)), 8
        )

    def alpha086(self):
        ####((0.25 < (((DELAY(CLOSE, 20) - DELAY(CLOSE, 10)) / 10) - ((DELAY(CLOSE, 10) - CLOSE) / 10))) ? (-1 * 1) :(((((DELAY(CLOSE, 20) - DELAY(CLOSE, 10)) / 10) - ((DELAY(CLOSE, 10) - CLOSE) / 10)) < 0) ?1 : ((-1 * 1) *(CLOSE - DELAY(CLOSE, 1)))))
        A = ((Delay(self.close, 20) - Delay(self.close, 10)) / 10) - (
    ...
    def alpha091(self):  # 1745
        ...
        return (
            Rank((self.close - Tsmax(self.close, 5)))
            * Rank(Corr((Mean(self.volume, 40)), self.low, 5))
        ) * -1
    ...
    def alpha092(self):  # 1786
        ...
        return (
            Max(
                Rank(
                    Decaylinear(Delta(((self.close * 0.35) + (self.vwap * 0.65)), 2), 3)
                ),
                Tsrank(
                    Decaylinear(Abs(Corr((Mean(self.volume, 180)), self.close, 13)), 5),
                    15,
                ),
            )
            * -1
    ...
    def alpha102(self):  # 1790
        ...
        return (
            Sma(Max(self.volume - Delay(self.volume, 1), 0), 6, 1)
            / Sma(Abs(self.volume - Delay(self.volume, 1)), 6, 1)
            * 100
        )
    ...
    def alpha104(self):  # 1657
        ...
        return -1 * (
            Delta(Corr(self.high, self.volume, 5), 5) * Rank(Std(self.close, 20))
        )
    ...
    def alpha108(self):  # 1178
        ...
        return (
            Rank((self.high - Tsmin(self.high, 2)))
            ** Rank(Corr((self.vwap), (Mean(self.volume, 120)), 6))
        ) * -1

    def alpha109(self):  # 1797
        ####SMA(HIGH-LOW,10,2)/SMA(SMA(HIGH-LOW,10,2),10,2)###
        return Sma(self.high - self.low, 10, 2) / Sma(
            Sma(self.high - self.low, 10, 2), 10, 2
        )
    ...
    def alpha110(self):  # 1650
        ...
        return (
            ...
            / Sum(Max(Delay(self.close, 1) - self.low, 0), 20)
            * 100
        )
    ...
    def alpha112(self):
        ...
        part2[cond] = 0
        return (
            (Sum(part1, 12) - Sum(part2, 12)) / (Sum(part1, 12) + Sum(part2, 12)) * 100
        )
    ...
    def alpha114(self):  # 1751
        ...
        return (
            Rank(Delay(((self.high - self.low) / (Sum(self.close, 5) / 5)), 2))
            * Rank(Rank(self.volume))
        ) / (
            ((self.high - self.low) / (Sum(self.close, 5) / 5))
    ...
    def alpha115(self):  # 1527
        ...
        return Rank(
            Corr(((self.high * 0.9) + (self.close * 0.1)), Mean(self.volume, 30), 10)
        ) ** Rank(
    ...
    def alpha119(self):  # 1626
        ...
        return Rank(
            Decaylinear(Corr(self.vwap, Sum(Mean(self.volume, 5), 26), 5), 7)
        ) - Rank(
            Decaylinear(
                Tsrank(
                    Tsmin(Corr(Rank(self.open), Rank(Mean(self.volume, 15)), 21), 9), 7
                ),
                8,
            )
        )
    ...
    def alpha121(self):  # 972   数据量较少
        ...
        return (
            ...
            ** Tsrank(
                Corr(Tsrank(self.vwap, 20), Tsrank(Mean(self.volume, 60), 2), 18), 3
            )
        ) * -1
    ...
    def alpha122(self):  # 1790
        ...
        return (
            ...
            - Delay(Sma(Sma(Sma(Log(self.close), 13, 2), 13, 2), 13, 2), 1)
        ) / Delay(Sma(Sma(Sma(Log(self.close), 13, 2), 13, 2), 13, 2), 1)
    ...
    def alpha125(self):  # 1678
        ...
        return Rank(
            Decaylinear(Corr((self.vwap), Mean(self.volume, 80), 17), 20)
    ...
    def alpha127(self):  # 公式有问题，我们假设mean周期为12
        ...
        return (
            Mean(
                (100 * (self.close - Tsmax(self.close, 12)) / (Tsmax(self.close, 12)))
                ** 2,
                12,
            )
        ) ** (1 / 2)
    ...
    def alpha130(self):  # 1657
        ...
        return Rank(
            Decaylinear(
                Corr(((self.high + self.low) / 2), Mean(self.volume, 40), 9), 10
            )
        ) / Rank(Decaylinear(Corr(Rank(self.vwap), Rank(self.volume), 7), 3))

    def alpha131(self):  # 1030
        ####(RANK(DELAT(VWAP, 1))^TSRANK(CORR(CLOSE,MEAN(VOLUME,50), 18), 18))###
        return Rank(Delta(self.vwap, 1)) ** Tsrank(
            Corr(self.close, Mean(self.volume, 50), 18), 18
        )
    ...
    def alpha133(self):
        ...
        return ((20 - Highday(self.high, 20)) / 20) * 100 - (
            (20 - Lowday(self.low, 20)) / 20
        ) * 100

    def alpha134(self):  # 1760
        ####(CLOSE-DELAY(CLOSE,12))/DELAY(CLOSE,12)*VOLUME###
        return (
            (self.close - Delay(self.close, 12)) / Delay(self.close, 12) * self.volume
        )
    ...
    def alpha138(self):  # 1448
        ...
        return (
            ...
            - Tsrank(
                Decaylinear(
                    Tsrank(
                        Corr(Tsrank(self.low, 8), Tsrank(Mean(self.volume, 60), 17), 5),
                        19,
                    ),
                    16,
                ),
    ...
    def alpha140(self):  # 1797
        ...
        return Min(
            Rank(
                Decaylinear(
                    (
                        (Rank(self.open) + Rank(self.low))
                        - (Rank(self.high) + Rank(self.close))
                    ),
                    8,
                )
            ),
            Tsrank(
                Decaylinear(
                    Corr(Tsrank(self.close, 8), Tsrank(Mean(self.volume, 60), 20), 8), 7
                ),
                3,
            ),
        )
    ...
    def alpha142(self):  # 1657
        ...
        return (
            (-1 * Rank(Tsrank(self.close, 10))) * Rank(Delta(Delta(self.close, 1), 1))
    ...
    def alpha145(self):  # 1617
        ...
        return (
            (Mean(self.volume, 9) - Mean(self.volume, 26)) / Mean(self.volume, 12) * 100
        )
    ...
    def alpha146(self):  # 1650
        ...
        return (
            Mean(
                (self.close - Delay(self.close, 1)) / Delay(self.close, 1)
                - Sma(
                    (self.close - Delay(self.close, 1)) / Delay(self.close, 1), 61, 2
                ),
                20,
            )
            * (
                (self.close - Delay(self.close, 1)) / Delay(self.close, 1)
                - Sma((self.close - Delay(self.close, 1)) / Delay(self.close, 1), 61, 2)
            )
            / Sma(
                (
                    (self.close - Delay(self.close, 1)) / Delay(self.close, 1)
    ...
    def alpha152(self):  # 1559
        ...
        return Sma(
            Mean(Delay(Sma(Delay(self.close / Delay(self.close, 9), 1), 9, 1), 1), 12)
            - Mean(
                Delay(Sma(Delay(self.close / Delay(self.close, 9), 1), 9, 1), 1), 26
            ),
            9,
            1,
        )
    ...
    def alpha155(self):  # 1797
        ...
        return (
            Sma(self.volume, 13, 2)
            - Sma(self.volume, 27, 2)
    ...
    def alpha156(self):  # 1776
        ...
        return (
            Max(
                Rank(Decaylinear(Delta(self.vwap, 5), 3)),
                Rank(
                    Decaylinear(
                        (
                            (
                                Delta(((self.open * 0.15) + (self.low * 0.85)), 2)
                                / ((self.open * 0.15) + (self.low * 0.85))
                            )
                            * -1
                        ),
                        3,
                ...
                Rank(
                    Rank(
                        Log(
                            Sum(
                                Tsmin(
                                    Rank(Rank((-1 * Rank(Delta((self.close - 1), 5))))),
                                    2,
                                ),
                                1,
                            )
    ...
    def alpha158(self):  # 1797
        ...
        return (
            (self.high - Sma(self.close, 15, 2)) - (self.low - Sma(self.close, 15, 2))
        ) / self.close
    ...
    def alpha159(self):  # 1630
        ...
        return (
            (
                (self.close - Sum(Min(self.low, Delay(self.close, 1)), 6))
                / Sum(
                    Max(self.high, Delay(self.close, 1))
                    - Min(self.low, Delay(self.close, 1)),
                    6,
                )
                * 12
                * 24
                + (self.close - Sum(Min(self.low, Delay(self.close, 1)), 12))
                / Sum(
                    Max(self.high, Delay(self.close, 1))
                    - Min(self.low, Delay(self.close, 1)),
                    12,
                ...
                * 6
                * 24
                + (self.close - Sum(Min(self.low, Delay(self.close, 1)), 24))
                / Sum(
                    Max(self.high, Delay(self.close, 1))
                    - Min(self.low, Delay(self.close, 1)),
                    24,
    ...
    def alpha161(self):  # 1714
        ...
        return Mean(
            Max(
                Max((self.high - self.low), Abs(Delay(self.close, 1) - self.high)),
                Abs(Delay(self.close, 1) - self.low),
            ),
            12,
        )
    ...
    def alpha163(self):  # 1657
        ...
        return Rank(
            (
                (((-1 * self.returns) * Mean(self.volume, 20)) * self.vwap)
    ...
    def alpha166(self):  # 公式有问题
        ...
        p1 = (
            ...
            * Sum(
                ...
                - 1
                - Mean(self.close / Delay(self.close, 1) - 1, 20),
                20,
            )
        )
        p2 = (
            (20 - 1)
            * (20 - 2)
            * (Sum(Mean(self.close / Delay(self.close, 1), 20) ** 2, 20)) ** 1.5
        )
        return p1 / p2
    ...
    def alpha169(self):  # 1610
        ...
        return Sma(
            Mean(Delay(Sma(self.close - Delay(self.close, 1), 9, 1), 1), 12)
            - Mean(Delay(Sma(self.close - Delay(self.close, 1), 9, 1), 1), 26),
            10,
            1,
        )
    ...
    def alpha170(self):  # 1657
        ...
        return (
            ...
            * ((self.high * Rank((self.high - self.close))) / (Sum(self.high, 5) / 5))
    ...
    def alpha176(self):  # 1678
        ...
        return Corr(
            Rank(
                (
                    (self.close - Tsmin(self.low, 12))
                    / (Tsmax(self.high, 12) - Tsmin(self.low, 12))
                )
            ),
            Rank(self.volume),
            6,
    ...
    def alpha179(self):  # 1421   数据量较少
        ...
        return Rank(Corr(self.vwap, self.volume, 4)) * Rank(
            Corr(Rank(self.low), Rank(Mean(self.volume, 50)), 12)
        )
    ...
    def alpha180(self):  # 指标有问题
        ...
        # part.loc[:, :] = None
        part.loc[:, :] = np.nan
        part[cond] = (-1 * Tsrank(Abs(Delta(self.close, 7)), 60)) * Sign(
            Delta(self.close, 7)
        )
    ...
    def alpha181(self):  # 1532  公式有问题，假设后面的sum周期为20
        ...
        return Sum(
            (
                (self.close / Delay(self.close, 1) - 1)
                - Mean((self.close / Delay(self.close, 1) - 1), 20)
            )
            - (self.benchmark_close - Mean(self.benchmark_close, 20)) ** 2,
            20,
        ) / Sum(((self.benchmark_close - Mean(self.benchmark_close, 20)) ** 3), 20)
    ...
    def alpha184(self):  # 983   数据量较少
        ...
        return Rank(Corr(Delay((self.open - self.close), 1), self.close, 200)) + Rank(
    ...
    def alpha188(self):  # 1797
        ...
        return (
            (self.high - self.low - Sma(self.high - self.low, 11, 2))
            / Sma(self.high - self.low, 11, 2)
        ) * 100
    ...
    def alpha191(self):  # 1721
        ...
        return (
            Corr(Mean(self.volume, 20), self.low, 5) + ((self.high + self.low) / 2)
        ) - self.close
